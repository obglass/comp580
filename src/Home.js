  ...
  return (
    <div class="instructions">
      ...
      <ul>
       ...
       <li>Make sure you set Rotor to rows.</li>
       <li>Move around the table until you find the cell that says ?, which is the missing number.</li>
      ...
      <ul>
       ...
       <li>Move your finger around the grid until you find ?, which is the missing number.</li>
